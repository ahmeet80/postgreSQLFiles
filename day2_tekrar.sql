...
INSERT INTO ogrenciler VALUES(128, 'Ali Can', 'Mehmet', 99); -- benim eklentim
select * from ogrenciler;
-- Soru : id'si 124 olan öğrenciyi siliniz
DELETE FROM ogrenciler WHERE id = 124;
DELETE FROM ogrenciler WHERE yazili_notu = 75; -- benim eklentim
...
delete from ogrenciler WHERE isim='Ali Can' and id=123; -- derste yanlış yazılmış (and yerine or)
-- Tablodaki tüm verileri silelim
Delete from ogrenciler
drop table ogrenciler; -- Benim eklentim
...
INSERT INTO adresler VALUES ('10012','Ağa Sok','30. Cad.','Antep'); -- 10012 parent olan calısanlar id de olamdıgı için ekleme yapılamaz
--Parent dosyada olmayan id ile child tabloya ekleme yapamayız
INSERT INTO adresler VALUES (NULL,'Ağa Sok.','30.Cad.','Antep'); -- foreign key olan tabloya null deger atanabilir
